...
function CreatePost() {
    ...
    const generateAiDrivenPost = async () => {
        ...
        const gender = user?.gender // ✅ חובה: male / female
        ...
        // ✅ אין unknown יותר. אם אין gender בכלל -> חובה לערוך פרופיל
        if (!gender) {
            toast.info("כדי ליצור פוסט בלשון נכונה, הגדירי מין בעמוד עריכת פרופיל")
            return;
        }
